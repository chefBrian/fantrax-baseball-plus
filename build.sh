...
cp src/shared/config-lib.js "$DIST/chrome/"
cp config/remote-config.json "$DIST/chrome/"
cp src/shared/content.css "$DIST/chrome/"
cp src/shared/popup.html "$DIST/chrome/"
cp src/shared/popup.js "$DIST/chrome/"
cp src/shared/setup.html "$DIST/chrome/"
cp src/shared/setup.js "$DIST/chrome/"
...
cp src/shared/config-lib.js "$DIST/firefox/"
cp config/remote-config.json "$DIST/firefox/"
cp src/shared/content.css "$DIST/firefox/"
cp src/shared/popup.html "$DIST/firefox/"
cp src/shared/popup.js "$DIST/firefox/"
cp src/shared/setup.html "$DIST/firefox/"
cp src/shared/setup.js "$DIST/firefox/"

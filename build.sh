...
echo "Building Fantrax+ v${VERSION}..."
rm -rf "$DIST"
...
cd "$DIST/chrome"
zip -r "../fantrax-plus-chrome-v${VERSION}.zip" .
cd ../..
echo "  -> dist/fantrax-plus-chrome-v${VERSION}.zip"
...
cd "$DIST/firefox"
zip -r "../fantrax-plus-firefox-v${VERSION}.zip" .
cd ../..
echo "  -> dist/fantrax-plus-firefox-v${VERSION}.zip"
